        ...
        ScrollView {
            VStack(spacing: 16) {
                ...
                SettingsGlassSection("Functions") {
                    NavigationLink { BaseCurrencyEditorView() } label: { SettingsLinkRow("Base Currency", systemImage: "coloncurrencysign.circle", detail: store.state.settings.baseCurrency.rawValue) }
                    Divider()
