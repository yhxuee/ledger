...
extension LedgerTransaction {
    init(
        ...
        exchangeRateAtTransaction: Double = 1.0,
        reversalOfTransactionID: UUID? = nil,
        reversalTransactionID: UUID? = nil,
        purchaseSessionID: UUID? = nil,
        purchaseItemID: UUID? = nil,
        recurringRuleID: UUID? = nil,
        groupMode: TransactionGroupMode? = nil,
        parentTransactionID: UUID? = nil,
        linkedTransactionKind: LinkedTransactionKind? = nil,
        linkedTransactionIndex: Int? = nil,
        linkedStatus: LinkedTransactionStatus? = nil,
        completedAt: Date? = nil,
        splitMetadata: SplitTransactionMetadata? = nil,
        installmentMetadata: InstallmentPlanMetadata? = nil,
        ...
        taxBaseAmount: Double? = nil,
        taxInputMode: TaxInputMode? = nil,
        isTaxExempt: Bool? = nil
    ) {
        self.id = id
        self.userID = userID
        self.type = type
        ...
        self.destinationAccountCurrency = destinationAccountCurrency
        self.categoryID = categoryID
        self.occurredAt = occurredAt
        self.note = note
        self.noteAttachmentID = noteAttachmentID
        self.exchangeRateAtTransaction = exchangeRateAtTransaction
        self.reversalOfTransactionID = reversalOfTransactionID
        ...
        self.linkedTransactionKind = linkedTransactionKind
        self.linkedTransactionIndex = linkedTransactionIndex
        self.linkedStatus = linkedStatus
        self.completedAt = completedAt
        self.splitMetadata = splitMetadata
        self.installmentMetadata = installmentMetadata
        self.couponSnapshot = couponSnapshot
        self.createdAt = createdAt
        self.updatedAt = updatedAt
        ...
        self.taxInputMode = taxInputMode
